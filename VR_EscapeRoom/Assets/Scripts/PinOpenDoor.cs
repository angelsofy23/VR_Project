...
public class PinOpenDoor : MonoBehaviour
{
    ...
    private static readonly List<int> correctSequence = new List<int> { 6, 9, 3, 3, 6, 6 };
    ...
    {
        isAnimating = true;
        Vector3 pressedPosition = originalPosition + Vector3.back * pressDepth;
